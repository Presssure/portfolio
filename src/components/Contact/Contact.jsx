...
const Contact = () => {
  return (
    <div className={appStyles['section-container']}>
      <Header header="Get in touch." details='Interested to collborate? Feel free to send me an email.'/>


      
      <div className={styles['social-icons-container']}>
        <a href="https://github.com/Presssure">
          <img className={styles['social-icon']} src={github} alt='github icon'/>
        </a>
        ...
        <a href="https://medium">
          <img className={styles['social-icon']} src={medium} alt='meidum icon'/>
        </a>
        <a href="web">
      ...
      <div className={styles['vector-frame']}>
        <img src={ContactVector} alt="vector" className={styles['about-vector']}/>
      </div>
    </div>
  );
};
